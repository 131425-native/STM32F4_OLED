...
#define TDIN 		PCout(11)  	//T_MOSI
#define TCLK 		PEout(1)  	//T_SCK
#define TCS  		PBout(8)  	//T_CS  
...
void TP_Drow_Touch_Point(u16 x,u16 y);//画一个坐标校准点
void TP_Draw_Big_Point(u16 x,u16 y);	//画一个大点
u8 TP_Scan(u8 tp);								//扫描
